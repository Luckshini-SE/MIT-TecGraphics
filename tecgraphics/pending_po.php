		...
		<?php include('topbar.php'); ?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
					<h1 class="h3 mb-3 col-10">Pending PO</h1>
							...
							<div class="card">
								<div class="card-body">
									...
									<table id="datatables-reponsive" class="table table-striped" style="width:100%">
										...
										<tbody>
										  <?php
										  $select_po = mysqli_query($con, "SELECT * FROM purchase_order_summary WHERE approval = 'pending'");
										  ...
										  <tr>
											...
											<td align="center"><a href="approve_purchase_order.php?qid=<?php echo $result_po['id']; ?>" ><button type="button" class="btn btn-success" title="Approve" ><i data-feather="check"></i></button></a></td>
										 </tr>
										  <?php } ?>
										</tbody>
									</table>
