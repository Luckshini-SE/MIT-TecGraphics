		...
		<?php include('topbar.php'); ?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Approve Quotation</h1>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									...
									<form name="quotation_form" method="post" action="approve_quotation_submit.php" onsubmit="return validateForm()" >
										<div class="row">
											...
											<div class="col-lg-2 col-xs-6 mb-3">
												...
												<input type="text" class="form-control" name="quot_date" id="quot_date" value="<?php echo $result_req['q_date']; ?>" readonly />
											</div>
											...
											<div class="col-lg-3 col-sm-6 mb-3">
												...
												<select class="form-select" name="sales_ex" id="sales_ex" >
													<?php
													$select_se = mysqli_query($con, "SELECT id, first_name, last_name FROM users WHERE user_type = '6' AND id = '{$result_req['sales_ex']}'");		//user type is sales executives
										...
										if($result_product['pricing'] == 1){
											$item_uprice = $result_quotitm['item_price'];
											$measure = '';
										} else {
											$item_uprice = $result_quotitm['item_price'];
                            ...
                            $description .= ' | '.$result_reqitm['spe_note'];
										...
										<div class="row" style="margin-top: 10px;">
											<div class="col-lg-6 mb-3">
												...
												<input type="hidden" name="prod_id<?php echo $i; ?>" id="prod_id<?php echo $i; ?>" value="<?php echo $result_quotitm['prod_id']; ?>" />
												<input type="hidden" name="row_id<?php echo $i; ?>" id="row_id<?php echo $i; ?>" value="<?php echo $result_quotitm['id']; ?>" />
											</div>
										...
										$result_fin = mysqli_fetch_array($select_fin);
											$finish_up = $result_quotitm['finishing'];
										?>

										<div class="row">
											<div class="col-lg-6 mb-3" style="text-align:right; margin-top:5px;">
												<?php echo $result_fin['name']; ?>
											</div>
											<div class="col-lg-2 mb-3">
										...
										$result_spo = mysqli_fetch_array($select_spo);
											$spec1_up = $result_quotitm['spec1'];
										?>

										<div class="row">
											<div class="col-lg-6 mb-3" style="text-align:right; margin-top:5px;">
												<?php echo $result_spo['name']; ?>
											</div>
											<div class="col-lg-2 mb-3">
										...
										$result_spt = mysqli_fetch_array($select_spt);
											$spec2_up = $result_quotitm['spec2'];
										?>

										<div class="row">
											<div class="col-lg-6 mb-3" style="text-align:right; margin-top:5px;">
												<?php echo $result_spt['name']; ?>
											</div>
											<div class="col-lg-2 mb-3">
										...
										<div class="row">
											...
											<div class="col-lg-2 mb-3">
												<input type="text" class="form-control" name="uprice<?php echo $i; ?>" id="uprice<?php echo $i; ?>" value="<?php echo number_format($result_quotitm['uprice'],2,'.',''); ?>" style="text-align: right;" readonly />
											</div>
											<div class="col-lg-2 mb-3">
												<input type="text" class="form-control" name="qty<?php echo $i; ?>" id="qty<?php echo $i; ?>" value="<?php echo $result_quotitm['qty']; ?>" readonly />
											</div>
											<div class="col-lg-2 mb-3">
												<input type="text" class="form-control" name="amount<?php echo $i; ?>" id="amount<?php echo $i; ?>" value="<?php echo number_format($result_quotitm['amount'],2,'.',''); ?>" style="text-align: right;" readonly />
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-lg-2 mb-3">
												<input type="text" class="form-control" name="aw_price<?php echo $i; ?>" id="aw_price<?php echo $i; ?>" onkeypress="return isNumberKeyn(event);" onchange="calculateSubTotal()" style="text-align: right;" <?php echo $aw_read; ?> value="<?php echo $aw_price; ?>" />
										...
										<div class="row" style="border-bottom: 1px solid #939ba2; margin-top: 5px;">
											...
											<div class="col-lg-2 mb-3">
												<input type="text" class="form-control" name="sv_price<?php echo $i; ?>" id="sv_price<?php echo $i; ?>" onkeypress="return isNumberKeyn(event);" onchange="calculateSubTotal()" style="text-align: right;" <?php echo $sv_read; ?> value="<?php echo $sv_price; ?>" />
										...
										<div class="row">
											...
											<div class="col-lg-2 mb-3">
												<input type="text" class="form-control" name="subtotal" id="subtotal" style="text-align: right;" value="<?php echo $result_req['subtotal']; ?>" readonly />
											</div>
										</div>
										...
										<div class="row">
											...
											<div style="display:flex">
												<input type="checkbox" name="disc_st" id="disc_st" onchange="enableDiscount()" <?php echo $dis_check; ?> />&nbsp;&nbsp;&nbsp;
												<input type="text" class="form-control" name="disc_per" id="disc_per" onkeypress="return isNumberKeyn(event);" onchange="calculateTotal()" style="text-align: right; width: 50%" <?php echo $dis_read; ?> value="<?php echo $dis_per; ?>" />&nbsp;%
											</div>
										...
										<div class="row">
											...
											<div class="col-lg-2 mb-3">
												<input type="text" class="form-control" name="total" id="total" style="text-align: right;" value="<?php echo $result_req['total']; ?>" readonly />
											</div>
										</div>

										<div class="row">
											<div class="col-lg-2 mb-3">
												<input type="submit" class="btn btn-success" name="submit" id="submit" value="Approve" />
											</div>
										</div>
