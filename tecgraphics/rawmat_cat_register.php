...
if(isset($_GET['id'])){
	...
	$select_pro = mysqli_query($con, "SELECT name FROM rawmaterial_category WHERE id = '$pid'");
		...
		<?php include('topbar.php'); ?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
					<h1 class="h3 mb-3 col-10">Raw Material Category</h1>
					<div class="col-2" align="right"><a href="rawmat_cat_list.php"><button class="btn btn-warning">View List</button></a></div>
					</div>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									...
									<form method="post" name="rmcat_form" action="rawmat_cat_register_submit.php" onsubmit="return validateForm()" >
										...
										<div class="row form-group mb-3">
											<div class="col-4  mb-3">
												...
												<input type="text" class="form-control" name="cname" id="cname" placeholder="Category Name" value="<?php echo $name; ?>" >
...
function validateForm() {
  ...
  let cname = document.forms["rmcat_form"]["cname"].value;
  if (cname == "") {
	document.getElementById("cname_error").innerHTML = "Category name must be filled";
