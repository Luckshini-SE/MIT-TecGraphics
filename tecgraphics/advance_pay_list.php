		...
		<?php include('topbar.php'); ?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
					<h1 class="h3 mb-3 col-10">Advance Payment List</h1>
					<div class="col-2" align="right"><a href="advance_payment.php"><button class="btn btn-success">Add</button></a></div>
					</div>
							...
							<div class="card">
								<div class="card-body">
									<table id="datatables-reponsive" class="table table-striped" style="width:100%">
										...
										<tbody>
										  <?php
										  $select_in = mysqli_query($con, "SELECT * FROM advance_payment");
										  ...
										  <tr>
											...
											<td><?php echo $result_in['description']; ?></td>
